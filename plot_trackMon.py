...
for fileintag in [
                ...
                #   prefix + with_tuning,
                  ...
                  prefix + Tx_100mu_TxTzRxRz,
                  prefix + Tx_100mu_TxRz,
                #   prefix + Tx_10mu_TxRz_LargeRxJoint,
                  prefix + Tx_10mu_TxRxRz_SmallSurveyRxUnc,
                  prefix + V2_constraint,
                #   prefix + Tx_10mu_SmallRxJoint,
...
for var in names:
    ...
    hist2=source[1].FindObjectAny(var)
    ...
    hist3=source[2].FindObjectAny(var)
    ...
    hist4=source[3].FindObjectAny(var)
    ...
    hist6=source[4].FindObjectAny(var)
    ...
    hist7=source[5].FindObjectAny(var)
    ...
    if var == 'chi2ProbVsMom':
        ...
        print(f'max: {filenames[3]}', max(bins_f4))
        # print(f'max: {filenames[5]}', max(bins_f5))
        print(f'max: {filenames[4]}', max(bins_f6))
        print(f'max: {filenames[5]}', max(bins_f7))
