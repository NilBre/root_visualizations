...
for var in names:
    ...
    # leg.AddEntry(hist3, "0.1 micron", "P")
    # leg.AddEntry(hist4, "2mm Tx", "P")
    # leg.AddEntry(hist5, "with tuning", "P")
    # leg.AddEntry(hist6, "2micron Tx", "P")
    leg.Draw()
    c3.Draw()
    c3.SaveAs(f"outfiles/compi/" + var + "_comp_close3.pdf")
